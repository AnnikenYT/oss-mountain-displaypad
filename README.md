...
- `displaypad_driver`: A low-level driver for communicating with the Mountain DisplayPad via USB.
- `displaypad`: A higher-level interface that simplifies common tasks such as setting images and managing device states.